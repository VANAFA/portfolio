...
(function () {
  ...
  var STRINGS = {
    en: {
      ...
      "pin.score": "Score",
      "pin.balls": "Balls",
      "pin.newGame": "New Game",
      "pin.left": "◄ Flipper",
      "pin.right": "Flipper ►",
      "pin.launchBtn": "Launch",
      "pin.help": "Z / ← and / / → flip, hold Space to launch — or use the buttons.",
      "pin.readyToLaunch": "Ready — hold Launch!",
      "pin.gameOver": "Game over.",
    ...
    es: {
      ...
      "pin.score": "Puntos",
      "pin.balls": "Bolas",
      "pin.newGame": "Juego Nuevo",
      "pin.left": "◄ Flipper",
      "pin.right": "Flipper ►",
      "pin.launchBtn": "Lanzar",
      "pin.help": "Z / ← y / / → mueven los flippers, mantené Espacio para lanzar — o usá los botones.",
      "pin.readyToLaunch": "Listo — mantené Lanzar!",
      "pin.gameOver": "Fin del juego.",
