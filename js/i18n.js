...
(function () {
  ...
  var STRINGS = {
    en: {
      ...
      "win.pinball": "Pinball",
      "tb.pinball": "Pinball",
      "pin.credit": "3D Pinball: Space Cadet, embedded from russo.github.io (a Windows 98 emulator running in the browser) - not built by me, just framed here so it lives on this desktop too.",
    ...
    es: {
      ...
      "win.pinball": "Pinball",
      "tb.pinball": "Pinball",
      "pin.credit": "3D Pinball: Space Cadet, embebido desde russo.github.io (un emulador de Windows 98 corriendo en el navegador) - no lo hice yo, solo lo enmarqué acá para que también viva en este escritorio.",
